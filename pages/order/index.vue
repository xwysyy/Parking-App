<template>
	<base-tab :tabIndex="tabIndex" :tabList="tabList" @changeTab="changeTab"
		style="display:flex; justify-content: center;"></base-tab>
	<view class="view">
		<view class="order">
				...
				<view class="order-item">
					...
					<view style="display: flex;" @click="getDetail(item.id)">
						<view style="width: 100%; text-align: end; padding: 8px;">
							<text style="color:grey;">查看详情</text>
						</view>
					</view>
				</view>
			</template>
...
<script setup>
	...
	import qs from 'qs'
	import baseTab from '../component/tab.vue'
	const page = reactive({
		total: 0,
		pageSize: 5,
		pageNum: 1
